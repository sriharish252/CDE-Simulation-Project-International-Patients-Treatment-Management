	...
	<div class="main-container-register">
		...
		<div class="section grid">
			...
			<div class="content list-container">
				<h1>Specialists by Expertise</h1>
				<div class="container">
					<form:form action="viewSpecialistsByExpertise" method="GET"
						modelAttribute="areaOfExpertise">
						<div class="form-group">
							<form:label path="ailment">Select Expertise:</form:label>
							<form:select path="ailment" class="form-control" id="ailment"
								items="${ailmentList}" required="required" />
						</div>
						<form:button class="btn">Search Specialists</form:button>
					</form:form>
				</div>
