...
public class IpTreatmentOfferingControllerUser {	// this controller is only for User
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = "/user/specialists")
	public ModelAndView showSpecialistPage(HttpServletRequest request) throws Exception {
		 ...
		 */
		System.out.println("Inside /user/specialists");
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = "/user/ipTreatmentPackages")
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = "/user/ipTreatmentPackageByName")
